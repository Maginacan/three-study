...
// 创建四个点，连成一条曲线，在让这条曲线围绕Y轴旋转一圈，就生成了一个几何体
const pointsArr = [
...
const latheGeometryMesh = new THREE.Mesh(geometry, materail);
...
latheGeometryMesh.add(points2, line2);

export default latheGeometryMesh;
